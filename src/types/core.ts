...
export const KnownIdsSchema = v.object({
  horus_customer_id: v.optional(NonEmptyStringSchema),
  customer_id: v.optional(NonEmptyStringSchema),
  user_id: v.optional(NonEmptyStringSchema),
  old_user_id: v.optional(NonEmptyStringSchema),
  form_id: v.optional(NonEmptyStringSchema),
  account_form_id: v.optional(NonEmptyStringSchema),
  alphadesk_user_id: v.optional(NonEmptyStringSchema),
  device_id: v.optional(NonEmptyStringSchema),
  account_id: v.optional(NonEmptyStringSchema),
  account_number: v.optional(NonEmptyStringSchema),
  phone: v.optional(NonEmptyStringSchema),
  utr: v.optional(NonEmptyStringSchema),
});
