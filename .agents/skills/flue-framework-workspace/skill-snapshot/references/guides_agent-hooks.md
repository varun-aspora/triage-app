...
- `useAgentFinish` has a fixed framework ceiling of 32 continuation cycles per response (not configurable); a hook that appends unconditionally fails the submission loudly.
